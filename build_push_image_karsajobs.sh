...
# and tag it with the name 'karsajobs' and version 'latest'.
docker build -t ghcr.io/deltarfd/karsajobs:latest .
...
# Push the Docker image ('karsajobs:latest') to the container registry ('ghcr.io').
docker push ghcr.io/deltarfd/karsajobs:latest